...
- **PHP网站(PHP Websites)**
    ...
    - [PHP School](https://www.phpschool.io/) - 一个开源的PHP学习资源
...
- [Nette](https://nette.org/) - 同样是由独立组件构成的框架
...
- [Silex](http://silex.sensiolabs.org/) - 基于Symphony2组件的微型框架
    - [Silex Skeleton](https://github.com/silexphp/Silex-Skeleton) - 用于Silex的项目框架
...
- [Slim](http://www.slimframework.com/) - 另一个简单的微型框架
    - [Slim Skeleton](https://github.com/slimphp/Slim-Skeleton) - 用于Slim的框架
    - [Slim View](https://github.com/slimphp/Slim-Views) - Slim的自定义视图集
    - [Slim Middleware](https://github.com/slimphp/Slim-Middleware) - Slim的自定义中间件集合
...
- [Lumen](https://lumen.laravel.com/) - 基于Laravel的微型框架
...
- [Klein](https://github.com/klein/klein.php) - 一个灵活的路由库
...
- [Phly Mustache](https://github.com/phly/phly_mustache) - 另一个PHP实现的Mustache模板语言
...
- [Goutte](https://github.com/FriendsOfPHP/Goutte) - 一个简单的Web抓取器
...
- [Flysystem](https://github.com/thephpleague/flysystem) - 另一个文件流的抽象层
...
- [PHP FFmpeg](https://github.com/PHP-FFMpeg/PHP-FFMpeg) - 一个用于FFmpeg视频包装的库
...
- [Acclimate](https://github.com/symfony/dependency-injection) - 依赖注入容器和服务定位器的通用接口
...
- [VFS](https://github.com/adlawson/php-vfs) - 另一个用于测试的虚拟文件系统
...
- [SemaphoreCI](https://semaphoreci.com/) - 一个给开源程序和私有项目的持续集成平台
- [PHPCI](https://www.phptesting.org/) - 一个PHP的开源持续集成平台
...
- [PHP Mess Detector](https://phpmd.org/) - 一个扫描代码bug、次佳代码和未使用参数的库
...
- [PHPCheckstyle](https://github.com/PHPCheckstyle/phpcheckstyle) - 一个帮助遵守特定代码规则的工具
- [PhpDependencyAnalysis](https://github.com/mamuz/PhpDependencyAnalysis) - 一个创建可定制型依赖关系图表的工具
- [Code Climate](https://codeclimate.com/) - 自动化的code review
...
- [Blackfire.io](https://blackfire.io/) - 一个低开销的代码探查器
...
- [Box](https://github.com/box-project/box2) - 用来构建PHAR文件的工具
...
- [JShrink](https://github.com/tedious/JShrink) - 一个JavaScript的压缩库
...
- [PHPPowerPoint](https://github.com/PHPOffice/PHPPresentation) - 处理PPT幻灯片的库
...
- [Propel](http://propelorm.org/) - 一个快速的ORM，迁移和查询库
...
- [ElasticSearch PHP](https://github.com/elastic/elasticsearch-php) - 用于 [ElasticSearch](https://www.elastic.co/) 的官方客户端库.
...
- [Boris](https://github.com/borisrepl/boris) - 一个微型的PHP REPL
...
- [GetOptionKit](https://github.com/c9s/GetOptionKit) - 同样还是一个命令行选择解析器
...
- [Shunt](https://github.com/thephpleague/shunt) -一个在多台远程机器上并行运行的命令行库
...
- [Alternative PHP Cache (APC)](http://php.net/manual/en/book.apc.php) - PHP的开源操作码缓存
...
- [PHP Object Storage](https://github.com/kherge-abandoned/php-object-storage) - 一个用于对象存储的库
- [Fractal](https://github.com/thephpleague/fractal) -  一个将复杂数据结构转换为JSON输出的库
- [Totem](https://github.com/Wisembly/Totem) - 一个管理和创建数据修改集的库
...
- [Notificato](https://github.com/mac-cain13/notificato) - 一个处理推送消息的库
...
- [Rocketeer](https://github.com/rocketeers/rocketeer) -  PHP的快速和简单部署器
